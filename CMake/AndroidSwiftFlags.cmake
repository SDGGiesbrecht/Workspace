...
set(CMAKE_Swift_COMPILER_TARGET x86_64-unknown-linux-android CACHE STRING "")
set(CMAKE_Swift_FLAGS "-resource-dir ${CMAKE_Swift_SDK}/usr/lib/swift -Xcc --sysroot=${CMAKE_ANDROID_NDK}/sysroot -Xclang-linker --gcc-toolchain=${CMAKE_ANDROID_NDK}/toolchains/x86_64-4.9/prebuilt/linux-x86_64 -Xclang-linker -fuse-ld=gold -Xclang-linker --sysroot=${CMAKE_ANDROID_NDK}/platforms/android-${CMAKE_ANDROID_API}/arch-x86_64" CACHE STRING "")
