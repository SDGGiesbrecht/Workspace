...
set(CMAKE_SWIFT_LINK_FLAGS
      ...
      -Xclang-linker --sysroot=${CMAKE_ANDROID_NDK}/toolchains/llvm/prebuilt/linux-x86_64/sysroot
...
set(CMAKE_Swift_COMPILER_TARGET x86_64-unknown-linux-android CACHE STRING "")
set(CMAKE_Swift_FLAGS "-resource-dir ${CMAKE_Swift_SDK}/usr/lib/swift -Xcc --sysroot=${CMAKE_ANDROID_NDK}/toolchains/llvm/prebuilt/linux-x86_64/sysroot -Xclang-linker --gcc-toolchain=${CMAKE_ANDROID_NDK}/toolchains/x86_64-4.9/prebuilt/linux-x86_64 -Xclang-linker -fuse-ld=gold -Xclang-linker --sysroot=${CMAKE_ANDROID_NDK}/toolchains/llvm/prebuilt/linux-x86_64/sysroot" CACHE STRING "")
