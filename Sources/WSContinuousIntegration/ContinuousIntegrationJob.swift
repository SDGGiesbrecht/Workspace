    ...
    -> [String]
  {
    ...
    case .windows:
      ...
      result.append(contentsOf: [
        ...
        commandEntry("echo 'Fetching ICU...'"),
        ...
        commandEntry("echo 'Setting up CMake...'"),
    ...
    case .windows:
      result.append(contentsOf: [
        commandEntry("echo 'Building \(try project.packageName())...'"),
        commandEntry(
        ...
        commandEntry("echo 'Fetching Swift’s runtime dependencies...'"),
        commandEntry(
        ...
        commandEntry("echo 'Testing \(try project.packageName())...'"),
