        ...
        private static let discussion = UserFacing<StrictString, InterfaceLocalization>({ localization in
            ...
            case .englishCanada:
                return [
                    ...
                    "",
                    "To inherit the documentation elsewhere, place “\u{23}documentation(identifier)” where the documentation would go (or above it if it already exists). Anything on the same line will be ignored (such as “//”).",
                    "",
                    "struct Teacher : Rambler {",
                    "    // \u{23}documentation(MyLibrary.Rambler.ramble)",
