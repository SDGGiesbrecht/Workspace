...
func runInitialize(andExit shouldExit: Bool) {
    ...
    case .application:
        ...
        source = [
            ...
            "    private typealias SystemApplicationDelegate = NSApplicationDelegate",
            "#else",
            "    import UIKit",
            "    private typealias SystemApplication = UIKit.UIApplication",
            "    private typealias SystemApplicationDelegate = UIApplicationDelegate",
            "#endif",
            "",
            "private let applicationDelegate = \(moduleName)()",
            "private class Application : SystemApplication {",
            "    override init() {",
            "        super.init()",
            ...
            "}",
            "",
            "@NSApplicationMain class \(moduleName) : NSObject, SystemApplicationDelegate {",
            "",
