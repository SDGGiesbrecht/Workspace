...
let latestStableVersion = Version(0, 1, 0)
private let thisVersion: Version? = nil // Set this to lastestStableVersion for release commits, nil the rest of the time.
