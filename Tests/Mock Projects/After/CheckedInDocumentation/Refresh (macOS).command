...
if workspace version > /dev/null 2>&1 ; then
    ...
    workspace refresh $1 $2 •use‐version 0.17.2
    ...
    ~/Library/Caches/ca.solideogloria.Workspace/Versions/0.17.2/workspace refresh $1 $2 •use‐version 0.17.2
elif ~/.cache/ca.solideogloria.Workspace/Versions/0.17.2/workspace version > /dev/null 2>&1 ; then
    echo "Using cached build of Workspace..."
    ~/.cache/ca.solideogloria.Workspace/Versions/0.17.2/workspace refresh $1 $2 •use‐version 0.17.2
else
    ...
    cd "${REPOSITORY}"
    /tmp/Workspace/.build/release/workspace refresh $1 $2 •use‐version 0.17.2
    rm -rf /tmp/Workspace
fi
