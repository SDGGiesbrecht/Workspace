...
if workspace version > /dev/null 2>&1 ; then
    ...
    workspace refresh $1 $2 •use‐version 0.18.1
    ...
    ~/Library/Caches/ca.solideogloria.Workspace/Versions/0.18.1/workspace refresh $1 $2 •use‐version 0.18.1
elif ~/.cache/ca.solideogloria.Workspace/Versions/0.18.1/workspace version > /dev/null 2>&1 ; then
    echo "Using cached build of Workspace..."
    ~/.cache/ca.solideogloria.Workspace/Versions/0.18.1/workspace refresh $1 $2 •use‐version 0.18.1
else
    ...
    cd "${REPOSITORY}"
    /tmp/Workspace/.build/release/workspace refresh $1 $2 •use‐version 0.18.1
    rm -rf /tmp/Workspace
fi
