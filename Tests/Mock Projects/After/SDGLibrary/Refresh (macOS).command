...
if workspace version > /dev/null 2>&1 ; then
    ...
    workspace refresh $1 $2 $3 $4 •use‐version 0.28.0
    ...
    ~/Library/Caches/ca.solideogloria.Workspace/Versions/0.28.0/workspace refresh $1 $2 $3 $4 •use‐version 0.28.0
elif ~/.cache/ca.solideogloria.Workspace/Versions/0.28.0/workspace version > /dev/null 2>&1 ; then
    echo "Using system cache of Workspace..."
    ~/.cache/ca.solideogloria.Workspace/Versions/0.28.0/workspace refresh $1 $2 $3 $4 •use‐version 0.28.0
elif .build/SDG/Workspace/workspace version > /dev/null 2>&1 ; then
    echo "Using repository cache of Workspace..."
    .build/SDG/Workspace/workspace refresh $1 $2 $3 $4 •use‐version 0.28.0
else
