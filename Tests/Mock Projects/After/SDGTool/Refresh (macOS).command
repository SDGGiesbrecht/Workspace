...
if workspace version > /dev/null 2>&1 ; then
    ...
    workspace refresh $1 $2 $3 $4 •use‐version [Current Version]
    ...
    ~/Library/Caches/ca.solideogloria.Workspace/Versions/[Current Version]/workspace refresh $1 $2 $3 $4 •use‐version [Current Version]
elif ~/.cache/ca.solideogloria.Workspace/Versions/[Current Version]/workspace version > /dev/null 2>&1 ; then
    echo "Using system cache of Workspace..."
    ~/.cache/ca.solideogloria.Workspace/Versions/[Current Version]/workspace refresh $1 $2 $3 $4 •use‐version [Current Version]
elif .build/SDG/Workspace/workspace version > /dev/null 2>&1 ; then
    echo "Using repository cache of Workspace..."
    .build/SDG/Workspace/workspace refresh $1 $2 $3 $4 •use‐version [Current Version]
else
